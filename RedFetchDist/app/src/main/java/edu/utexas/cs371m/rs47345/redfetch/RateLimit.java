...
/*RateLimit.java This class is a singleton class that takes requests and dispatches them at most
once very two seconds.

A request should implement a public interface called RateLimit.RateLimitCallback, with a single
(zero argument) function.
        Check this out. https://en.wikipedia.org/wiki/Initialization-on-demand_holder_ idiom
        Hint: Your rate limit class is the only class with a Handler and a Runnable.*/
