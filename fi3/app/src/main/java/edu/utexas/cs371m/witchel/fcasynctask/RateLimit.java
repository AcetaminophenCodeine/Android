...
// fetch more than a URL every 5 seconds.  It is a bit fancier than the version
// I distributed in class because it will "save up" 5 seconds so that a
// new request after 5 seconds of inactivity will immediately fetch.
public class RateLimit {
    ...
    protected final int rateLimitMillis = 5000; // 5 sec
