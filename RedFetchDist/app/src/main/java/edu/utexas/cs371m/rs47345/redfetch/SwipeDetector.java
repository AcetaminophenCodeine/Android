...
/*SwipeDetector.java This code is adapted from stack overflow, with Tyler providing some integration
 with RecyclerView. It detects swipes, which is a useful thing because one of the requirements is
 that you can delete list view items with a right to left swipe.*/
